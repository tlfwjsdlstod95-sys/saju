...
export default function NamingCard({ result }: { result: SajuResult }) {
  ...
  return (
    <div className="card naming-card">
      ...
      <p className="daily-foot">발음오행(소리) 기준의 참고용 안내입니다. 한자 자원오행·획수(수리) 길흉까지 보려면 전문 작명을 권합니다.<br />※ 초성 오행은 작명 실무에서 통용되는 기준(아ㄱㅋ=목 / 설ㄴㄷㄹㅌ=화 / 순ㅁㅂㅍ=수 / 치ㅅㅈㅊ=금 / 후ㅇㅎ=토)을 따릅니다. 훈민정음 해례본은 순음=토·후음=수로 보아 결과가 달라질 수 있어요.</p>
    </div>
  );
}
